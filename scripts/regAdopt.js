...
let caja_trasera_login=document.getElementsByClassName(".caja__trasera-login");
let caja_trasera_register=document.getElementsByClassName(".caja__trasera-register");
